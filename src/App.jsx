...
function App() {
  ...
  const[data,setdata]=useState([])
   async function fetch_api(limit){
    ...
    console.log('asxsxsax',response.data,'ssss')
    }
    catch(error){
    ...
    <div className='max-w-[1440px] h-dvh mx-auto '>
      ...
      <div className='max-w-[1440px] mx-auto bg-amber-100'>
       <div className='border-[4px] border-[black] max-w-[800px] rounded-2xl bg-purple-200  h-[100px] flex justify-center items-center mx-auto'>
        ...
        <input type="text" className='border-[2px] border-[purple] m-[5px] h-[50px] max-w-[500px]' placeholder='pleae enter the number for limit'  value={limit} onChange={(event)=>{setLimit(event.target.value)}}/>
       </div>
       <div>
        you value is: {limit}
       </div>
      ...
      <div className=' bg-[#E3E6E6] max-w-dvw border-[1px]  h-auto p-[10px] py-[20px] my-[0px] grid grid-cols-2 gap-[20px] sm:grid-cols-3 mx-auto '>
                     ...
                     return(
                       <div key={index}>
                           ...
                           <div className=" w-[180px] sm:w-[440px]  h-auto p-[4px] bg-blue-100 border-[0px]  mx-auto cursor-pointer" id='card '>
                            ...
                            <img src={products.thumbnail} alt={products.category}  className=' border-b-[0px] border-[0px] rounded-[3px] border-[black] bg-white w-[200px] sm:w-dvw my-[10px] mt-[1px] h-auto  hover:border-b-[1px]'/>
                            <h4 className='hover:underline text-green-700 hover:text-green-800 font-[800] sm:font-[700] text-[11px] sm:text-[18px]  mt-[-8px] sm:my-[-4px] border-0 sm:border-0 '>{products.title}</h4>
                             <div className='flex '>
